            ...
            <div class="col-md-4 col-lg-3">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab"
                        aria-controls="v-pills-settings" aria-selected="false"><i class="fa fa-cog"></i>&nbsp;
                        My Account Details</a>
                    <a class="nav-link" id="v-pills-password-tab" data-toggle="pill" href="#v-pills-password" role="tab"
                        aria-controls="v-pills-password" aria-selected="false"><i class="fa fa-lock"></i>&nbsp;
                        Change Password</a>
                </div>
            </div>
            ...
            <div class="col-md-8 col-lg-9 mt-4 mt-md-0">
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-profile" role="tabpanel"
                        ...
                        <div class="tab-content__block">
                            ...
                            <div class="alert alert-success" role="alert">
                                You are a member since {{date('M j, Y',strtotime($subscriber_profile->created_at))}}.
                                And Your Plan
                                reminaing Days is {{$remaining}} day/s.If you want to renew before Time, Please <a
                                    class="btn"
                                    style="border-color: #192133;background-color: #192133;padding: 2px 2px 2px 2px;color: white;"
                                    href="{{ route('subscription-package')}}">Renew / Subscribe Now</a>
                            </div>
                            @else
                            <div class="alert alert-danger" role="alert">
                                You are Out of Subsription Time, PLease Renew Soon.<a
                                    href="{{ route('subscription-package')}}">Subscribe Now</a>. Otherwise Your Account
                                might be Disabled.
                            </div>
                            @endif
                            ...
                            @else
                            <div class="alert alert-danger" role="alert">
                                You have not yet subscribed. <a href="{{ route('subscription-package')}}">Subscribe
                                    Now</a> and become a member for exclusive member benefits.
                            </div>
                            @endif
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="productInfo">
                                            <h6 class="mb-0">{{ ucfirst(str_replace('_',' ',$subscriber_plan->plan))}}
                                                Package</h6>
                                        </td>
                                        <td class="text-center">{{$subscriber_plan->start_date}}</td>
                                        <td class="text-center">{{$subscriber_plan->end_date}}</td>
                                        <td class="text-center"><img title="khalti" style="height: auto;width: 20%;"
                                                src="{{asset('home/images/khalti.png')}}"></td>
                                        <td class="text-center">{{ucfirst($subscriber_plan->status)}}</td>
                                    </tr>
                                    @else
                                    <tr colspan="6">You have not yet subscribed. <a
                                            href="{{ route('subscription-package')}}">Subscribe Now</a> and become a
                                        member for exclusive member benefits.</tr>
                                    @endif
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="tab-content__block">
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    {!! Form::text('username', $value = null, ['id'=>'username','placeholder'=>'Enter
                                    Username','class'=>'edit_content form-control','required','readonly']) !!}
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="validationCustom02">Full Name</label>
                                    {!! Form::text('full_name', $value = null, ['id'=>'full_name','placeholder'=>'Enter
                                    Full Name','class'=>'edit_content form-control','required','readonly']) !!}
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <label for="exampleInputEmail1">Email address</label>
                                    {!! Form::email('email', $value = null, ['id'=>'email','placeholder'=>'Enter
                                    Email','class'=>'form-control','required','readonly']) !!}
                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with
                                        anyone else.</small>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="validationCustom02">Contact No.</label>
                                    {!! Form::text('mobile_no', $value = null, ['id'=>'mobile_no','placeholder'=>'Enter
                                    Mobile No.','class'=>'edit_content form-control','readonly']) !!}
                                </div>
                            </div>
                            <div class="form-group row mt-4">
                                <div class="col-sm-10">
                                    ...
                                    <button class="btn btn-success submit_account" type="submit"
                    ...
                    <div class="tab-pane fade" id="v-pills-password" role="tabpanel"
                        ...
                        <div class="tab-content__block">
                            {!!
                            Form::open(['route'=>'subscriber-update-password','method'=>'POST','class'=>'needs-validation','role'=>'form','files'
                            => true]) !!}
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <label for="validationCustom01">Old Password</label>
                                    {!! Form::text('old_password', $value = null,
                                    ['id'=>'old_password','placeholder'=>'Old Password','class'=>'form-control']) !!}
                                </div>
                                <div class="col-md-6 mb-3">
