                            ...
                            <div class="col-12 col-md-7">
                                <div class="pricing-card">
                                    <table class="table mb-0">
                                        ...
                                        <tr>
                                            <th scope="col"></th>
                                            <th scope="col" class="text-center"><h6><span class="badge badge-secondary">1 Month</span></h6></th>
                                            <th scope="col" class="text-center"><h6><span class="badge badge-warning">3 Months</span></h6></th>
                                            <th scope="col" class="text-center"><h6><span class="badge badge-danger">6 Months</span></h6></th>
                                            <th scope="col" class="text-center"><h6><span class="badge badge-primary">1 Year</span></h6></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">Rs.{{$subscription_payment->three_month_payment}}</td>
