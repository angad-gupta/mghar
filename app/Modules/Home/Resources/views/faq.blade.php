                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="headingOne{{$key}}">
                                        <h4 class="panel-title">
                                            <a class="{{$collapsed}}" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne{{$key}}" aria-expanded="{{$expand}}" aria-controls="collapseOne{{$key}}">
                                                {{$value->question}}
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="collapseOne{{$key}}" class="panel-collapse {{$panel_colls}}" role="tabpanel" aria-labelledby="headingOne{{$key}}">
