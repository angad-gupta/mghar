...
trait HtmlTableTrait
{
    public function getEmployeeTable($employment, $employee_id)
    {
        ...
        $html .= "<tr>";
        $html .= "<td colspan='4'><h3>Employee Access Detail</h3></td>";
        $html .= "</tr>";

        $html .= "<tr>";
        $html .= "<td class='text-success'>Username</td>";
        $html .= "<td>".optional($employee->getUser)->username."</td>";
        $html .= "<td class='text-success'>User Type</td>";
        $html .= "<td>".optional($employee->getUser)->user_type."</td>";
        $html .= "</tr>";
