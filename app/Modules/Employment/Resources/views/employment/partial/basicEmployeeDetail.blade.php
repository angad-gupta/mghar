<fieldset class="mb-3">
    <legend class="text-uppercase font-size-sm font-weight-bold">Employee</legend>
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-6">
            <div class="row">
                <label class="col-form-label col-lg-3">Ethnic:</label>
                    <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                        <div class="input-group">
                            <span class="input-group-prepend">
                        ...
                        {!! Form::select('cast_ethnic',$ethnic, $value = null, ['id'=>'cast_ethnic','placeholder'=>'Select Ethnic','class'=>'form-control']) !!}
                        </div>
                    </div>
            </div>
        </div>
