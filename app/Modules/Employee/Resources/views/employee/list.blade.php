...
<div class="card card-body" id="employee-list-card">
    ...
    <div class="table-responsive">
        <table class="{{ config('admin.table-class') }}" id="employee-list-table">
            <thead>
                <tr class="{{ config('admin.table-header-class') }}">
                    <th>#</th>
                    <th>Name</th>
                    <th>Branch</th>
                    <th>Designation</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ optional($employee->branchValue)->dropvalue }}</td>
                    <td>{{ optional($employee->designation)->dropvalue }}</td>
                    <td title="{{ date_converter()->eng_to_nep_convert($employee->join_date) }}">{{ $employee->join_date }}</td>
