        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                @if($menuRoles->assignedRoles('role.index') || Auth::user()->user_type == 'super_admin')
                    <li class="nav-item">
                        <a href="{{route('role.index')}}" class="nav-link @if($Route[0]=='role') active @endif" data-popup="tooltip" data-original-title="Role Management"
                           data-placement="right"><i class="icon-pencil5"></i><span>Role Management</span>
                        </a>
                    </li>
                @endif
                ...
                @if($menuRoles->assignedRoles('genre.index'))
                    <li class="nav-item">
                        <a href="{{route('genre.index')}}" class="nav-link @if($Route[0]=='genre') active @endif" data-popup="tooltip" data-original-title="Genre Management"
                           data-placement="right"><i class="icon-theater"></i><span>Genre Management</span>
                        </a>
                    </li>
                @endif
                ...
                @if($menuRoles->assignedRoles('video.index'))
                    <li class="nav-item">
                        <a href="{{route('video.index')}}" class="nav-link @if($Route[0]=='video') active @endif" data-popup="tooltip" data-original-title="Video Management"
                           data-placement="right"><i class="icon-clapboard-play"></i><span>Video Management</span>
                        </a>
                    </li>
                @endif
                ...
                @if($menuRoles->assignedRoles('khelaujuhari.index'))
                    <li class="nav-item">
                        <a href="{{route('khelaujuhari.index')}}" class="nav-link @if($Route[0]=='khelaujuhari') active @endif" data-popup="tooltip" data-original-title="Khelau Juhari Management"
